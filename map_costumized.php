	    ...
	    if ($form_id !=0) {
	       ...
	       if ($step_id !=0) {
	        ...
	        $sql = "UPDATE step SET "
	            ...
	            . ",recording=".$conn->quote($recording)
...
<script>
  ...
  function createDownloadLink() {
    recorder && recorder.exportWAV(function(blob) {
     ...
     bt.onclick =  function(){ uploadAudio(blob); }
     bt.disabled = true;
    ...
    __log('Saved on server.');
      ...
      bt_select.textContent = "Select Recording";
      			bt_select.onclick =  function(){ selectRecording(url); }
				li.appendChild(bt_select);	
     bt_select.disabled = true;
     bt_select.previousElementSibling.disabled = false;
    });
  }
  	...
  	function uploadAudio(wavData){
		...
		var PageToSendTo = "map_costumized.php?";
...
<table border="1" cellpadding="10">
    ...
    <td>
        <h1> Add a step </h1>
        <form action="map_costumized.php" method = "post">
 ...
 Form name: <br /> <input type="text" name="form_name" value="" /><br />
		    ...
		    <button href="#two">Change?</button>
			 <a href="#changeRecording">Change?</a>
			        <section id="changeRecording">
