function __log(e, data) {
  ...
  function startUserMedia(stream) {
    ...
    __log('Ready to record ! Wanna hear a clear voice !:)');
  }
    ...
    function deleteCookie(){
      ...
      function selectRecording(button,url){
        ...
        button.previousElementSibling.disabled = false;
         ...
         __log('Recording selected. CONGRATULATIONS ! :)');
/*
...
function saveOnServer(blob){
  ...
  window.onload = function init() {
    try {
     ...
     __log((navigator.getUserMedia ? 'Your browser is good, ready to record.' : 'There is an error with your browser!'));
    } catch (e) {
